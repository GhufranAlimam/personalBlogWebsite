...
###### CSS Imports
4. There should be at least 3 imported files in the main CSS file, but the student is welcome to break it down even further if that makes it easier for them.

###### Directories & Files
5. Files are organized with a directory structure that separates files based on page and functionality.

###### Links
6. There is an intentional user flow on each page with appropriate links as needed.

========================
======== Design ======== 
========================
###### Custom Design
1. Custom images, layout, and styling.
